...
class TestAmfArray extends FunSuite
{
    ...
    val boolsBuf = BufUtils.mkb(0x09, 0x07, 0x01, 0x03, 0x03, 0x02)

    val intsList = new ArrayList(Arrays.asList(1, 2, 3, -4))
    val intsBuf = BufUtils.mkb(0x09, 0x09, 0x01,
			0x04, 0x01,
			0x04, 0x02,
			0x04, 0x03,
    ...
    val doublesBuf = BufUtils.mkb(0x09, 0x07, 0x01,
    ...
    val stringsBuf = BufUtils.mkb(0x09, 0x09, 0x01,
			0x06, 0x03, 0x61,
			0x06, 0x03, 0x62,
			0x06, 0x03, 0x63,
    ...
    val anyBuf = BufUtils.mkb(0x9, 0x9, 0x1,
            0x4, 0x1,
    ...
    val arrBuf = BufUtils.mkb(0x9, 0x7, 0x1,
            0x9, 0x7, 0x1,
    ...
    val arrObjBuf = BufUtils.mkb(0x9, 0x7, 0x1,
             0xa, 0xb, 0x1, // obj1
    ...
    val arrObjBuf2 = BufUtils.mkb(0x9, 0x7, 0x1,
              0xa, 0xb, 0x1,
    ...
    val arrClassBuf = BufUtils.mkb(0x9, 0x9, 0x1,
               0xa, 0x43, 0x1,
    ...
    val arrRClassBuf = BufUtils.mkb(0x9, 0x9, 0x1,
               0xa, 0x43, 0x1d, // user1
    ...
    val mixedBuf = BufUtils.mkb(0x9, 0xf, 0x1,
            0x3, // true
            0xa, 0xb, 0x1,
                0x9, 0x6e, 0x61, 0x6d, 0x65, // name
                0x6, 0x7, 0x42, 0x6f, 0x62, // Bob
